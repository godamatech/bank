...
public class WithdrawAccountType extends JFrame implements ActionListener {
	JPanel panel;
	...
	public WithdrawAccountType(String cardNo) {
		panel = new JPanel();
	...
	public void setCurCardNo(String curCardNo) {
		this.curCardNo = curCardNo;
	}
