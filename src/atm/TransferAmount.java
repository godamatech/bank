...
public class TransferAmount extends JFrame implements ActionListener {
	...
	public TransferAmount(String cardNo, String accountNo) {
		...
		this.setTitle("Select Amount to be Transfered");
		this.add(panel);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == btnClose) {
			...
			transfer(getAmount());
			//msg goes here!
			System.err.println("Amount: N"+getAmount() + "\nCard No:"+curCardNo);
			this.dispose();
			...
			new TransferOtherAmount(curCardNo);
			this.dispose();
		}
